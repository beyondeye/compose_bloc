...
//    implementation(project(":kbloc_compose"))
    ...
    implementation(project(":kbloc_androidx"))
//    implementation("io.github.beyondeye:kbloc-navigator-android:0.9.1")
    ...
    implementation("androidx.compose.ui:ui-tooling-preview:${Versions.compose_core_libs_version}")
    ...
    androidTestImplementation("androidx.compose.ui:ui-test-junit4:${Versions.compose_core_libs_version}")
    debugImplementation("androidx.compose.ui:ui-tooling:${Versions.compose_core_libs_version}")
    debugImplementation("androidx.compose.ui:ui-test-manifest:${Versions.compose_core_libs_version}")
}