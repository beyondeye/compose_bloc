...
//the code in this file has been extracted from https://developer.android.com/jetpack/androidx/releases/lifecycle#2.6.0-alpha01
//todo When we will update to androidx_lifecycle_version to 2.6.x then will be remove this code
//for some comments on how this code works see also https://medium.com/androiddevelopers/consuming-flows-safely-in-jetpack-compose-cde014d0d5a3
